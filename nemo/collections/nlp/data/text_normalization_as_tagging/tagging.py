...
class EditingTask(object):
    ...
    def realize_output(
        ...
        # output_tokens_str = output_tokens_str.strip()
        print("output_tokens_str:", output_tokens_str)
        ...
        for frag in frags:
            ...
            #     frag = re.sub(r"_(\S)", r"@\1", frag)
            #     print(frag)
            #     frag = re.sub(r"(\S)_", r"\1", frag)
            #     print(frag)
            #     frag = frag.replace(" ", "")
            #     print(frag)
            #     frag = frag.replace("@", " ")
            ...
            #     frag = frag.strip()
            #     print(frag)
            #     output_tokens.append(frag)
            # else:
            #     output_tokens.append(frag.strip().replace(" ", "").replace("_", ""))

            frag = re.sub(r"_(\S)", r"<d>\1", frag)
            print(frag)
            frag = re.sub(r"(\S)_", r"\1", frag)
            print(frag)
            frag = frag.replace(" ", "")
