...
from nemo.collections.common.tokenizers.youtokentome_tokenizer import (
...
def get_tokenizer(
    ...
    if tokenizer_name == "sentencepiece":
        ...
        return YouTokenToMeTokenizer(
            model_path=tokenizer_model, bpe_dropout=bpe_dropout
        )
...
def get_nmt_tokenizer(
    ...
    if library == "yttm":
        ...
        return YouTokenToMeTokenizer(
            model_path=tokenizer_model, bpe_dropout=bpe_dropout, r2l=r2l
        )
        ...
        return get_tokenizer(
            tokenizer_name=model_name, vocab_file=vocab_file, merges_file=merges_file
        )
