        ...
        try:
            ...
            if vocab_file is None:
                self.tokenizer = AUTOTOKENIZER.from_pretrained(
                    pretrained_model_name_or_path=pretrained_model_name, use_fast=use_fast, revision="f03d752280bf9025f4a3d9ed3b7f763f452f431d",
                )
            elif merges_file is None:
                self.tokenizer = AUTOTOKENIZER.from_pretrained(
                    pretrained_model_name_or_path=pretrained_model_name, vocab_file=vocab_file, use_fast=use_fast, revision="f03d752280bf9025f4a3d9ed3b7f763f452f431d",
                )
            else:
                self.tokenizer = AUTOTOKENIZER.from_pretrained(
                    ...
                    use_fast=use_fast,
                    revision="f03d752280bf9025f4a3d9ed3b7f763f452f431d",
                )
