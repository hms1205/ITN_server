...
def parse_input_example_decoder(input_example):
    input_list = list(input_example)
    input_dict = {}
    # process possible kwargs
    if isinstance(input_list[-1], dict):
        input_dict = input_list[0]
        decoder_input_list = input_list[1]
        input_list = input_list[2:-1]
        labels = input_list[-1]
    return input_list, decoder_input_list, input_dict, labels
